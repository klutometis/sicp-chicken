...
;;; TODO: Should we use our own false primitive here? The author's
;;; don't, I believe: "false" is a primitive.
...
(define (expand-clauses clauses)
  ;; TODO: The book has a quoted false; '#f evaluates to #f, though.
...
(define the-global-environment (make-parameter (setup-environment)))

(define input-prompt (make-parameter ";;; M-Eval input:"))
(define output-prompt (make-parameter ";;; M-Eval value:"))
(define (driver-loop)
